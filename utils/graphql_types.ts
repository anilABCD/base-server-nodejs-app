...
type MUTATION_INPUT_PROPERTY_NAME = "@INPUT_TYPE";
let MUTATION_INPUT_PROPERTY_NAME_: RegExp = /@INPUT_TYPE/g;
function MUTATION_INPUT_PROPERTY_NAME(str: MUTATION_INPUT_PROPERTY_NAME) {
  let queryProp: RegExp = MUTATION_INPUT_PROPERTY_NAME_;
  return queryProp;
}
