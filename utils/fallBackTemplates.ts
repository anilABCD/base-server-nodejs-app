                                    ...
                                    <tbody>
                                       <tr>
                                          <td>
                                             <!-- CONTENT-->
                                             <p>Hi {firstName},</p>
                                             <p>Forgot your password? Submit a PATCH request with your new password and passwordConfirm to: http://localhost/api/v1/users/resetPassword/30cd256d12e07174a7dfd088158006afddb21053f8df38b537d37e47aa14c28c.</p>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                           <tbody>
                              <tr>
                                 ...
                                 <td class="content-block"><span style="font-size:8px">Fallback Template</span></td>
                              </tr>
                           </tbody>
                        </table>
                     </div>
